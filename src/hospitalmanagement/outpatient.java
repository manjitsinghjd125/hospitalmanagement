...
filegenreate file=new filegenreate();
             ...
             Gender=file.data("gender.txt");
              Bloodgroup=file.data("blood.txt");
               Address=file.data("address.txt");
                ...
                status=file.data("status.txt"); tabledata();
    }
   ...
   for(int x=0;x<name.size();x++){
    ...
    private void initComponents() {
        ...
        jLabel7.setText("OutPatients Management");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(480, 30, 240, 20);

        setSize(new java.awt.Dimension(1077, 642));
 ...
 status.add((String)jComboBox2.getSelectedItem());
  ...
  for(int x=0;x<name.size();x++){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            int n = name.size();
            FileWriter writer= new FileWriter("OutPatient.txt",true);
            for(int i = 0;i<n;i++){
