 ...
 * @author manjitsingh
 */
public class Doctormgnt extends javax.swing.JFrame {
List title= new ArrayList();
    ...
    /**
     * Creates new form Doctormgnt
     */
    public Doctormgnt() {
        initComponents();
        name=file.data("Dname.txt");
            Age=file.data("Dage.txt");
             Gender=file.data("Dgender.txt");
             
               Address=file.data("Daddress.txt");
                Postal=file.data("Dpostal.txt");
                country=file.data("Dcountry.txt");
                contact=file.data("Dcontact.txt");
                status=file.data("Dstatus.txt");
//         title.addAll(Arrays.asList("Name","age","gender", "Address","postal code","Country","Status","contact No."));
//        name.addAll(Arrays.asList("Gurpreet Singh","john richer","Harjeet","Ashley","Sunny leone"));
//        Age.addAll(Arrays.asList("35","46","30","28","38"));
//        Gender.addAll(Arrays.asList("Male","Male","Male","Female","Female"));
//       
//        Address.addAll(Arrays.asList("7 higgns cres.","11 Street ","20Happy Street","88 ghost Street","19 honey street"));
//        Postal.addAll(Arrays.asList("L6P 0A4","L6P 0A5" ,"L6P 0A5" ,"L6P 0A9","L6P 0A6"));
//        country.addAll(Arrays.asList("India","Canada","India","USA","USA"));
//        status.addAll(Arrays.asList("Active","Active","Deactive","Deactive","Active"));
//        contact.addAll(Arrays.asList("6412102003","5718112004","3410102007","2413062011","3524072012"));
        tabledata();
    }
    ...
    model.setRowCount(0);
      ...
      model.addColumn("Name");
           ...
           model.addRow(new Object[]{name.get(x),Age.get(x),Gender.get(x),Address.get(x),Postal.get(x),country.get(x),status.get(x),contact.get(x)});
       }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(740, 440, 75, 29);
        ...
        jButton2.setBounds(830, 440, 75, 29);
        ...
        jButton3.setBounds(930, 440, 84, 29);

        jLabel1.setText("Doctor Name:");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(707, 90, 90, 16);
        ...
        jLabel5.setBounds(750, 190, 60, 16);

        jLabel6.setText("Postal code: ");
        jLabel6.setMinimumSize(new java.awt.Dimension(79, 16));
        getContentPane().add(jLabel6);
        jLabel6.setBounds(730, 280, 80, 16);

        jLabel8.setText("Country:");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(720, 310, 54, 16);
        ...
        jTextField1.setBounds(800, 80, 170, 30);
        ...
        jTextField2.setBounds(800, 110, 60, 26);
        ...
        jScrollPane2.setBounds(810, 180, 244, 84);
        ...
        jTextField3.setBounds(810, 280, 142, 26);

        jLabel9.setText("Status:");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(760, 350, 43, 16);

        jLabel10.setText("Contact No.:");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(730, 390, 79, 16);
        getContentPane().add(jTextField5);
        jTextField5.setBounds(810, 310, 160, 30);
        ...
        jTextField6.setBounds(810, 380, 170, 30);

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Status:", "Active", "Deactive" }));
        getContentPane().add(jComboBox2);
        jComboBox2.setBounds(810, 340, 140, 27);
        ...
        jButton5.setBounds(930, 0, 60, 29);
        ...
        jButton6.setBounds(990, 0, 80, 29);

        jLabel7.setFont(new java.awt.Font("Malayalam MN", 1, 18)); // NOI18N
        jLabel7.setText("Doctors Management");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(480, 30, 210, 20);

        setSize(new java.awt.Dimension(1066, 659));
  ...
  for(int x=0;x<name.size();x++){
         ...
         file.file("Dname.txt", name);
        file.file("Dage.txt", Age);
        file.file("Dgender.txt", Gender);
       
        file.file("Dcountry.txt", country);
        file.file("Dpostal.txt", Postal);
        file.file("Dstatus.txt", status);
        file.file("Daddress.txt", Address);
        file.file("Dcontact.txt", contact);
        //jLabel1.setText("yes");
 ...
 for(int x=0;x<name.size();x++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctormgnt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
